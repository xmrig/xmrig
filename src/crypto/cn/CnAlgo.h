...
#       endif
#       ifdef XMRIG_ALGO_CN_EXTREMELITE
        Algorithm::CN_2,    // CN_EXTREMELITE_0,
#       endif
#       ifdef XMRIG_ALGO_RANDOMX
