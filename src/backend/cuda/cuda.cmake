...
if (WITH_CUDA)
   ...
   if (WITH_ANIMICA)
       list(APPEND HEADERS_BACKEND_CUDA src/backend/cuda/runners/CudaAnimicaRunner.h)
       list(APPEND SOURCES_BACKEND_CUDA src/backend/cuda/runners/CudaAnimicaRunner.cpp)
   endif()
else()
