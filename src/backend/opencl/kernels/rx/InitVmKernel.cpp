...
void xmlcore::InitVmKernel::enqueue(cl_command_queue queue, size_t threads, uint32_t iteration)
{
...
void xmlcore::InitVmKernel::setArgs(cl_mem entropy_data, cl_mem vm_states, cl_mem rounding)
{
