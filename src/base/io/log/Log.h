...
#ifndef xmlcore_LOG_H
#define xmlcore_LOG_H
...
#define LOG_EMERG(x, ...)   xmlcore::Log::print(xmlcore::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   xmlcore::Log::print(xmlcore::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    xmlcore::Log::print(xmlcore::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     xmlcore::Log::print(xmlcore::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    xmlcore::Log::print(xmlcore::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  xmlcore::Log::print(xmlcore::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    xmlcore::Log::print(xmlcore::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (xmlcore::Log::verbose() > 0) { xmlcore::Log::print(xmlcore::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (xmlcore::Log::verbose() > 0) { xmlcore::Log::print(xmlcore::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (xmlcore::Log::verbose() > 1) { xmlcore::Log::print(xmlcore::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (xmlcore::Log::verbose() > 2) { xmlcore::Log::print(xmlcore::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (xmlcore::Log::verbose() > 3) { xmlcore::Log::print(xmlcore::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (xmlcore::Log::verbose() > 4) { xmlcore::Log::print(xmlcore::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) xmlcore::Log::print(xmlcore::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  xmlcore::Log::print(xmlcore::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) xmlcore::Log::print(xmlcore::Log::WARNING, x, ##__VA_ARGS__)
#else
