 ...
 */
xmlcore::TlsConfig::TlsConfig(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
bool xmlcore::TlsConfig::generate(const char *commonName)
{
    TlsGen gen;
...
rapidjson::Value xmlcore::TlsConfig::toJSON(rapidjson::Document &doc) const
{
