...
xmlcore::HttpServer::HttpServer(const std::shared_ptr<IHttpListener> &listener) :
    m_listener(listener)
{
}


xmlcore::HttpServer::~HttpServer()
{
    HttpContext::closeAll();
}


void xmlcore::HttpServer::onConnection(uv_stream_t *stream, uint16_t)
{
