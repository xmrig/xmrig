...
if (CMAKE_CXX_COMPILER_ID MATCHES GNU)
    ...
    elseif (XMRIG_PPC)
        if (NOT PPC_CPU)
            if (XMRIG_PPC_BITS EQUAL 32)
                set(PPC_CPU "750")
            elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "le$")
                set(PPC_CPU "power8")
            else()
                set(PPC_CPU "power7")
            endif()
        endif()
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mcpu=${PPC_CPU}")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mcpu=${PPC_CPU}")
        message(STATUS "PowerPC tuning: -mcpu=${PPC_CPU}")
